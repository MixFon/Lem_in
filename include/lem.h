...
/*   Updated: 2019/08/02 13:57:33 by widraugr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** File cut_ways.c
*/
int					finish_cut(t_ant *ant, t_ways *pre, int *now_step,
		int *pre_step);
...
*/
void				node_is_visited(t_nlst *lst, t_ways *iter,
		t_node *cur_node);
...
t_node				*search_cur_node(t_node *node, t_ant *ant, t_nlst **lst,
		t_ways *iter);
...
** File part_way.c
*/
int					part_way(t_node *node, t_nlst **lst, t_ways *iter,
		t_ant *ant);
...
** File finish.c
*/
void				solution_print(char c, int num, char *name_edg,
		t_nlst **del);
void				finish(t_node *node, t_ant *ant);
void				add_to_num_edges_help(t_nlst *pre, t_nlst ***edg,
		t_nlst **temp, char *name);
